...
const RegisterModal = ({ isOpen, onClose, onSwitchToLogin }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        showSuccess('Registration Successful', 'Welcome to Smart Energy Hub!');
        onClose();
        setFormData({
          name: '',
          email: '',
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            >
              ...
              <option value="both">Both Consumer & Producer</option>
            </select>
          </div>
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
              You can add your wallet address later in settings
            </p>
          </div>
